...
(function () {
    ...
    AutoPager.prototype.addPage = function (htmlDoc, page) {
        ...
        if (page[0] && /tr/i.test(page[0].tagName)) {
            ...
            if (this.insertPoint.className == "autopagerize_page_info") {
                var insertPoint = this.insertPoint.nextSibling
                var insertPointNext = this.insertPoint.nextSibling
            } else {
                var insertPoint = this.insertPoint
                var insertPointNext = this.insertPoint.nextSibling
            }
            this.insertPoint.parentNode.insertBefore(hr, insertPoint)
            this.insertPoint.parentNode.insertBefore(p, insertPoint)
            this.insertPoint = this.insertPoint.parentNode.insertBefore(p2, insertPointNext)
        }
        ...
        aplink.href = this.requestURL
        aplink.appendChild(document.createTextNode(String(this.pageNum)))
        p2.appendChild(document.createTextNode('page: '))
        p2.appendChild(aplink)
